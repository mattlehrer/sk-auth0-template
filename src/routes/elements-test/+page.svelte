<header>
	...
	<p>
		A project by <a href="https://alexandersandberg.com">Alexander Sandberg</a> ·
		<a href="https://github.com/alexandersandberg/html5-elements-tester">GitHub repository</a>
	</p>
</header>
...
<main id="main">
	...
	<section id="sections">
		<header>
			<h2>Sections</h2>
			<p>
				Elements: <code>&lt;body&gt;</code>, <code>&lt;article&gt;</code>,
				<code>&lt;section&gt;</code>, <code>&lt;nav&gt;</code>, <code>&lt;aside&gt;</code>,
				<code>&lt;h1&gt;–&lt;h6&gt;</code>, <code>&lt;header&gt;</code>, <code>&lt;footer&gt;</code>
			</p>
		</header>
	...
	<section id="grouping-content">
		<header>
			...
			<p>
				Elements: <code>&lt;p&gt;</code>, <code>&lt;address&gt;</code>, <code>&lt;hr&gt;</code>,
				<code>&lt;pre&gt;</code>, <code>&lt;blockquote&gt;</code>, <code>&lt;ol&gt;</code>,
				<code>&lt;ul&gt;</code>, <code>&lt;li&gt;</code>, <code>&lt;dl&gt;</code>,
				<code>&lt;dt&gt;</code>, <code>&lt;dd&gt;</code>, <code>&lt;figure&gt;</code>,
				<code>&lt;figcaption&gt;</code>, <code>&lt;main&gt;</code>, <code>&lt;div&gt;</code>
			</p>
		</header>
	...
	exactly as written
		...
		<article>
			...
			<figure>
				...
				<figcaption>
					<cite>Naval Ravikant (@naval)</cite> on
					<a href="https://twitter.com/naval/status/1002103497725173760">Twitter</a>.
				</figcaption>
			</figure>
		</article>
		...
		<article>
			...
			<p>
				See the <a href="#main">main content</a> of this page for a use case of
				<code>&lt;main&gt;</code>.
			</p>
		</article>
	...
	<section id="text-level-semantics">
		<header>
			...
			<p>
				Elements: <code>&lt;a&gt;</code>, <code>&lt;em&gt;</code>, <code>&lt;strong&gt;</code>,
				<code>&lt;small&gt;</code>, <code>&lt;s&gt;</code>, <code>&lt;cite&gt;</code>,
				<code>&lt;q&gt;</code>, <code>&lt;dfn&gt;</code>, <code>&lt;abbr&gt;</code>,
				<code>&lt;ruby&gt;</code>, <code>&lt;rb&gt;</code>, <code>&lt;rt&gt;</code>,
				<code>&lt;rtc&gt;</code>, <code>&lt;rp&gt;</code>, <code>&lt;data&gt;</code>,
				<code>&lt;time&gt;</code>, <code>&lt;code&gt;</code>, <code>&lt;var&gt;</code>,
				<code>&lt;samp&gt;</code>, <code>&lt;kbd&gt;</code>, <code>&lt;sub&gt;</code>,
				<code>&lt;sup&gt;</code>, <code>&lt;i&gt;</code>, <code>&lt;b&gt;</code>,
				<code>&lt;u&gt;</code>, <code>&lt;mark&gt;</code>, <code>&lt;bdi&gt;</code>,
				<code>&lt;bdo&gt;</code>, <code>&lt;span&gt;</code>, <code>&lt;br&gt;</code>,
				<code>&lt;wbr&gt;</code>
			</p>
		</header>
		...
		<article id="a">
			...
			<ul>
				<li>
					<a href="https://github.com/alexandersandberg/html5-elements-tester"
		...
		<article>
			...
			>
			<p>
				More information about the explanation and usage of these can be <a
					href="https://www.w3.org/TR/2017/REC-html52-20171214/single-page.html#the-ruby-element"
					target="_blank">read here on www.w3.org</a
				>.
			</p>
		</article>
		...
		<article>
			...
			<p>
				A <code>&lt;span&gt;</code> can be used to mark up inline text for various uses,
				<span style="font-weight: bolder;">here to make the text bolder</span>.
			</p>
			<p>
	...
	<section id="edits">
		...
		<article>
			...
			<p>
				If you make a <del>really huge</del> mistake, you can always go back and fix it later.
				<ins>And don't forget to learn from your mistake.</ins>
			</p>
			<ins
				><p>
					Both <code>&lt;ins&gt;</code> and <code>&lt;del&gt;</code> can be block-level, like this.
				</p></ins
			>
	...
	<section id="embedded-content">
		<header>
			...
			<p>
				Elements: <code>&lt;picture&gt;</code>, <code>&lt;source&gt;</code>,
				<code>&lt;img&gt;</code>, <code>&lt;iframe&gt;</code>, <code>&lt;embed&gt;</code>,
				<code>&lt;object&gt;</code>, <code>&lt;param&gt;</code>, <code>&lt;video&gt;</code>,
				<code>&lt;audio&gt;</code>, <code>&lt;track&gt;</code>, <code>&lt;map&gt;</code>,
				<code>&lt;area&gt;</code>, <code>&lt;math&gt;</code>, <code>&lt;svg&gt;</code>
			</p>
		</header>
		...
		<article>
			...
			<iframe
				title="Google Map"
				src="https://maps.google.com/maps?width=100%&amp;height=600&amp;hl=en&amp;q=New%20york+(HTML5%20Elements%20Tester)&amp;ie=UTF8&amp;t=k&amp;z=14&amp;iwloc=B&amp;output=embed"
			></iframe>
		</article>
		...
		<article>
			...
			<p>
				Audio is from <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/audio"
					>an example on MDN</a
				>.
			</p>
			...
			<p>
				Video and subtitles are from <a
		...
		<article>
			...
			<map name="image-map" id="image-map">
				<area alt="circle" shape="circle" coords="75,75,75" href="#image-map" />
				<area alt="circle" shape="circle" coords="275,75,75" href="#body" />
			</map>
			<img
				usemap="#image-map"
				src="https://placekeanu.com/350/150/y"
				alt="Keanu Reeves looking fine"
			/>
		</article>
	...
	<section id="tabular-data">
		<header>
			<h2>Tabular data</h2>
			<p>
				Elements: <code>&lt;table&gt;</code>, <code>&lt;caption&gt;</code>,
				<code>&lt;colgroup&gt;</code>, <code>&lt;col&gt;</code>, <code>&lt;tbody&gt;</code>,
	...
	<section id="forms">
		<header>
			<h2>Forms</h2>
			<p>
				Elements: <code>&lt;form&gt;</code>, <code>&lt;label&gt;</code>, <code>&lt;input&gt;</code>,
				<code>&lt;button&gt;</code>, <code>&lt;select&gt;</code>, <code>&lt;datalist&gt;</code>,
				<code>&lt;optgroup&gt;</code>, <code>&lt;option&gt;</code>, <code>&lt;textarea&gt;</code>,
				<code>&lt;output&gt;</code>, <code>&lt;progress&gt;</code>, <code>&lt;meter&gt;</code>,
					...
					<p>
						<label for="datalist">
							...
							<datalist id="datalist">
								<option value="Option 1"> </option><option value="Option 2"> </option><option
									value="Option 3"
								>
								</option><option value="Option 4"> </option></datalist
							>
						</label>
					</p>
					<p>
					...
					<p>
						<label for="input-image">
							Image button: <input
								...
								type="image"
								id="input-image"
								src="https://placekeanu.com/100/40"
							/>
						</label>
					</p>
					<p>
		...
		<article>
			...
			<form on:submit|preventDefault={() => {}}>
				<fieldset>
					...
					<p>
						Code is taken from <a
							href="https://www.w3.org/TR/2017/REC-html52-20171214/single-page.html#example-5b22c23a"
							target="_blank">this example by W3</a
						>.
					</p>
				</fieldset>
			</form>
	...
	<section id="interactive-elements">
		<header>
			...
			<p>
				Elements: <code>&lt;details&gt;</code>, <code>&lt;summary&gt;</code>,
				<code>&lt;dialog&gt;</code>
			</p>
		</header>
...
<footer>
	<p>
		<a href="https://github.com/alexandersandberg/html5-elements-tester">HTML5 elements tester</a>
		by <a href="https://alexandersandberg.com">Alexander Sandberg</a> ·
		<a href="#body">Back to top 👆</a>
	</p>
</footer>
